...
class Account {
	...
	public Account(Double bal) {
		System.out.println("Account initialized with " + bal + " in the account.");
		Balance = bal;
	}
	...
	public void addBalance(Double bal) {
		System.out.println("Deposited " + bal + " into the account.");
		Balance += bal;
	}
	
	public void subBalance(Double bal) {
		System.out.println("Withdrew " + bal + " from the account.");
		Balance -= bal;
	}
}
